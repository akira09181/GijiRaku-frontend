...
export const CITIZEN_QUESTIONS: readonly CitizenQuestionDefinition[] = [
  ...
  },
  {
    ...
    questionId: 'chuo-afterschool-care-v1',
    municipality: '中央区',
    theme: '学童保育と預かり場所の確保',
    ...
    draft: {
      templateId: 'chuo-afterschool-care-opinion-v1',
      answerStatements: {
        prioritize: '中央区の学童保育と預かり場所の確保を優先して進めてほしいです。',
        steady_progress: '中央区の学童保育と預かり場所の確保は、慎重に段階的に進めてほしいです。',
        need_more_information: '学童保育と預かり場所の確保は、具体策を示してから判断したいです。',
      },
      reasonClauses: {
  ...
  },
  {
    ...
    questionId: 'kodaira-nursery-staff-v1',
    municipality: '小平市',
    theme: '市立保育園の保育士確保',
    ...
    draft: {
      templateId: 'kodaira-nursery-staff-opinion-v1',
      answerStatements: {
        prioritize: '小平市の市立保育園の保育士確保を優先して進めてほしいです。',
        steady_progress: '小平市の市立保育園の保育士確保は、慎重に段階的に進めてほしいです。',
        need_more_information: '市立保育園の保育士確保は、具体策を示してから判断したいです。',
      },
      reasonClauses: {
        resident_need: '地域のニーズが高いこと',
        implementation: '具体策や費用が気になること',
  ...
  },
  {
    ...
    questionId: 'akishima-working-parents-v1',
    municipality: '昭島市',
    theme: '子育て世代が働きやすいまち',
    ...
    draft: {
      templateId: 'akishima-working-parents-opinion-v1',
      answerStatements: {
        prioritize: '昭島市の子育て世代が働きやすいまちを優先して進めてほしいです。',
        steady_progress: '昭島市の子育て世代が働きやすいまちは、慎重に段階的に進めてほしいです。',
        need_more_information: '子育て世代が働きやすいまちは、具体策を示してから判断したいです。',
      },
      reasonClauses: {
        resident_need: '地域のニーズが高いこと',
        implementation: '具体策や費用が気になること',
  ...
  },
  {
    ...
    questionId: 'ome-childcare-environment-v1',
    municipality: '青梅市',
    theme: '人口減少対策と子育て環境',
    ...
    draft: {
      templateId: 'ome-childcare-environment-opinion-v1',
      answerStatements: {
        prioritize: '青梅市の人口減少対策と子育て環境を優先して進めてほしいです。',
        steady_progress: '青梅市の人口減少対策と子育て環境は、慎重に段階的に進めてほしいです。',
        need_more_information: '人口減少対策と子育て環境は、具体策を示してから判断したいです。',
      },
      reasonClauses: {
        resident_need: '地域のニーズが高いこと',
        implementation: '具体策や費用が気になること',
  ...
  },
  {
    ...
    questionId: 'higashiyamato-family-support-v1',
    municipality: '東大和市',
    theme: '妊産婦や子育て家庭への支援',
    ...
    draft: {
      templateId: 'higashiyamato-family-support-opinion-v1',
      answerStatements: {
        prioritize: '東大和市の妊産婦や子育て家庭への支援を優先して進めてほしいです。',
        steady_progress: '東大和市の妊産婦や子育て家庭への支援は、慎重に段階的に進めてほしいです。',
        need_more_information: '妊産婦や子育て家庭への支援は、具体策を示してから判断したいです。',
      },
      reasonClauses: {
        resident_need: '地域のニーズが高いこと',
        implementation: '具体策や費用が気になること',
  ...
  },
  {
    ...
    questionId: 'kiyose-disaster-preparedness-v1',
    municipality: '清瀬市',
    theme: '清瀬市の防災対策',
    ...
    draft: {
      templateId: 'kiyose-disaster-preparedness-opinion-v1',
      answerStatements: {
        prioritize: '清瀬市の清瀬市の防災対策を優先して進めてほしいです。',
        steady_progress: '清瀬市の清瀬市の防災対策は、慎重に段階的に進めてほしいです。',
        need_more_information: '清瀬市の防災対策は、具体策を示してから判断したいです。',
      },
      reasonClauses: {
        resident_need: '地域のニーズが高いこと',
        implementation: '具体策や費用が気になること',
  ...
  },
  {
    ...
    questionId: 'musashimurayama-elderly-depression-v1',
    municipality: '武蔵村山市',
    theme: '高齢者のうつ病対策',
    ...
    draft: {
      templateId: 'musashimurayama-elderly-depression-opinion-v1',
      answerStatements: {
        prioritize: '武蔵村山市の高齢者のうつ病対策を優先して進めてほしいです。',
        steady_progress: '武蔵村山市の高齢者のうつ病対策は、慎重に段階的に進めてほしいです。',
        need_more_information: '高齢者のうつ病対策は、具体策を示してから判断したいです。',
      },
      reasonClauses: {
        resident_need: '地域のニーズが高いこと',
        implementation: '具体策や費用が気になること',

...
const TOKYO_ASSEMBLIES: readonly Assembly[] = [
  {
    ...
    totalMinutesCount: 4,
    hotTopic: 'データとエビデンスに基づく政策精度の向上',
    mainIssues: [
      { theme: 'child', label: '地域別の政策効果', count: 1 },
      { theme: 'dx', label: 'データ・エビデンス活用', count: 1 },
      { theme: 'redevelop', label: '区市町村別の課題検証', count: 1 },
      { theme: 'medical', label: '成果指標・政策評価', count: 1 },
    ],
    sourceUrl: 'https://www.gikai.metro.tokyo.lg.jp/record/proceedings/2026-1/03-01.html',
    lastMeetingDate: '2026/2/26｜第1回定例会',
